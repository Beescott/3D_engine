...
{
public:
	Plane(Vector3 const& pos = Vector3(0.0f, 0.0f, 0.0f), Vector3 const& nor = Vector3(0.0f, 1.0f, 0.0f), Material const& mat = Material(), Vector3 const& col = Vector3(1.0f, 1.0f, 1.0f));
	~Plane();
